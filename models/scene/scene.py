...
from models.scene.blender_loader import readBlenderInfo
from models.scene.colmap_loader import readColmapInfo
from models.scene.scannet_loader import readScanNetInfo,readMatterport3DInfo
from models.utils.camera_utils import cameraList_from_camInfos, camera_to_JSON, loadCam
...
class Scene:
    def __init__(self, args, plypath=None,resolution_scales=[1.0]):
        self.train_cameras = {}
        self.test_cameras = {}

        # load scene
        if "matterport" in args.scene_path.lower():
            print("assuming Matterport3D data set!")
        ...
        elif os.path.exists(os.path.join(args.scene_path, "pose")):
